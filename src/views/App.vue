  ...
  <dev-article>
    <Row :gutter="16">
      <i-col span="6">
        <Card shadow title="访问量">
          ...
          <Divider></Divider>日访问量，1200
        </Card>
      </i-col>
      <i-col span="6">
        <Card shadow title="总销售额">
          <Tooltip content="这里是指标说明" slot="extra" placement="top">
            <Icon size="18" type="ios-alert-outline"/>
          </Tooltip>
          <div class="count">¥ 888，000</div>
          <Divider></Divider>同周比 12%
      ...
      <i-col span="6">
        <Card shadow title="快捷操作">
          <Row>
            <i-col v-for="(item, index) in shortcuts" :key="index" span="8">
    ...
    <Card shadow style="margin-top: 16px">
      <Tabs>
        ...
        <TabPane label="访问量" name="visit">2</TabPane>
      </Tabs>
    </Card>
    <Modal v-model="newShortcut.status" title="添加快捷操作" @on-ok="handleAddNewShortcut">
